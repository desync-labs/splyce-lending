...
pub fn handle_init_lending_market(
    ...
    let lending_market_key = lending_market.key();
    ...
    lending_market.init(InitLendingMarketParams {
        ...
        signer.key(), //make the owner as signer. So that in other instructions that need to drive lending market PDA, it's easier.
        quote_currency,
